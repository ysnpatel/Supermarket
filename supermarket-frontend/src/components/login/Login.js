...
export default function SignInSide() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post (`http://localhost:8080/users/login/`, data, {
      ...
      setCurrentUserInfo(res.data.currentUser)
    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://resources.stuff.co.nz/content/dam/images/4/y/q/z/u/q/image.related.StuffLandscapeSixteenByNine.710x400.247kts.png/1651173810988.jpg?format=pjpg&optimize=medium)',
